package com.tengshi.basemodule.globalconfig;
...
public final class PermissionConstants {
    ...
    public static final String REQUEST_INSTALL = permission.REQUEST_INSTALL_PACKAGES;
    ...
    @StringDef({CALENDAR, CAMERA, CONTACTS, LOCATION, MICROPHONE, PHONE, SENSORS, SMS, STORAGE,REQUEST_INSTALL})
