...
public final class SPUtils {
    ...
    public void put(@NonNull final String objKey, final Object valueObj) {
        if (valueObj instanceof Integer) {
            put(objKey, (Integer) valueObj, false);
        } else if (valueObj instanceof String) {
            put(objKey, (String) valueObj, false);
        } else if (valueObj instanceof Boolean) {
            put(objKey, (Boolean) valueObj, false);
        } else if (valueObj instanceof Float) {
            put(objKey, (Float) valueObj, false);
        } else if (valueObj instanceof Long) {
            put(objKey, (Long) valueObj, false);
        } else {
            put(objKey, valueObj.toString(), false);
        }
    }
